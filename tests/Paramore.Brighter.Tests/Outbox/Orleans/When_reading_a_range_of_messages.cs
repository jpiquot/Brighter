...
namespace Paramore.Brighter.Tests.Outbox.Orleans
{
    ...
    public class OrleansRangeOfMessagesTests : BaseOrleansOutboxTests
    {
        ...
        public OrleansRangeOfMessagesTests()
        {
            ...
            OrleansOutbox.Add(_messageEarliest);
            OrleansOutbox.Add(_message2);
            OrleansOutbox.Add(_messageLatest);
            OrleansOutbox.Add(_nonTopicMessage);
        }

        [Fact]
        public void When_reading_messages_by_numerical_range()
        {
            var exception = Catch.Exception(() => OrleansOutbox.Get(3, 1));
        ...
        {
            var retrievedMessages = OrleansOutbox.Get(_topic, _timeStamp, _timeStamp.AddHours(-3), _timeStamp.AddHours(-2));
        ...
        {
            var retrievedMessages = OrleansOutbox.Get(_topic, _timeStamp, _timeStamp.AddHours(-2));
        ...
        {
            var retrievedMessages = OrleansOutbox.Get(_topic, _timeStamp, endTime: _timeStamp.AddHours(-2));
